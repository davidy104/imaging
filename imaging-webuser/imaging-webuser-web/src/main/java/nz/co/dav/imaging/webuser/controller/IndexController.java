...
public class IndexController extends BaseController {
	...
	public static final String MODEL_ATTRIBUTE_IMAG_PATHS = "imagePaths";
	...
	public String search(@ModelAttribute("searchInfo") SearchTerm searchTerm,
		...
		Set<String> imagePathSet = Collections.<String> emptySet();
		imagePathSet = imagingDs.getImagingUrisByTag(searchTerm.getTag(), searchTerm.getScalingType());
		model.addAttribute(MODEL_ATTRIBUTE_IMAG_PATHS, imagePathSet);
		return INDEX_VIEW;
	}
