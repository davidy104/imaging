...
<script type="text/javascript"
	src="static/js/vendor/bootstrap-transition.js"></script>
<script type="text/javascript"
	src="static/js/vendor/bootstrap-alert.js"></script>
<script type="text/javascript"
	src="static/js/vendor/bootstrap-collapse.js"></script>
<script type="text/javascript"
	src="static/js/vendor/bootstrap-modal.js"></script>
<script type="text/javascript"
	src="static/js/vendor/handlebars-1.0.0.beta.6.js"></script>
<script type="text/javascript" src="static/js/imaging.js"></script>

<sitemesh:write property="head" />
<title><spring:message code="imagingweb.title" /></title>
</head>
<body>
					...
					<div class="container">
						...
						<div class="nav-collapse">
							<ul id="navigation" class="nav">
								<li id="navi-homepage-link"><a href="/"><spring:message
											code="header.home.link.label" /></a></li>
